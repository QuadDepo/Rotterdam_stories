...
<div id="login">
  ...
  <div class="row">
    ...
    <div class="col-xs-10 col-xs-offset-1">
      ...
      <div class="form-group">
        <input type="password" placeholder="Wachtwoord" class="form-control rd-input" id="wachtwoord">
      </div>
      <p>Wachtwoord vergeten? <a href="wachtwoord_vergeten.html">Klik hier</a></p>
    </div>
    <div class="bottom">
