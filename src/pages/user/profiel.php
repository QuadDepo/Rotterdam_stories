      ...
      <div id="profiel">
        ...
        <div class="container">
          ...
          <div class="col-xs-12 newWW">
            ...
            <div class="form-group">
              <input type="password" placeholder="Oud wachtwoord" class="form-control rd-input" id="oud_ww">
            </div>
            <div class="form-group">
              <input type="password" placeholder="Nieuw Wachtwoord" class="form-control rd-input" id="nieuw_ww">
            </div>
            <div class="form-group">
              <input type="password" placeholder="Nieuw wachtwoord" class="form-control rd-input" id="nieuw_ww2">
            </div>
          </div>
...
// TODO: Kortingen button js
        ...
        $('#kortingen').click(function(){
          window.location.href = '/quiz/kortinglijst.html'
        })
