      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 comment">
            <div class="inner">
              <h5>Iemand<span><i class="fa fa-thumbs-down"></i></span></h5>
              <p>Gids af en toe echt onduidelijk en tijd niet erg goed verdeeld over de plekken.</p>
            </h5>
          </div>
        </div>
          <div class="col-xs-12 comment">
            <div class="inner">
              <h5>Iemand<span><i class="fa fa-thumbs-up"></i></span></h5>
              <p>Super leuke tour! Erg naar me zin gehad</p>
            </h5>
          </div>
        </div>
          <div class="col-xs-12 comment">
            <div class="inner">
              <h5>Iemand<span><i class="fa fa-thumbs-up"></i></span></h5>
              <p>Erg veel geleert over Rotterdam! Leuke gids, zeker aan te raden</p>
            </h5>
          </div>
        </div>
          <div class="col-xs-12 comment">
            <div class="inner">
              <h5>Iemand<span><i class="fa fa-thumbs-down"></i></span></h5>
              <p>Leuke tijd, gehad maar gids was af en toe onduidelijk</p>
            </h5>
          </div>
        </div>
          <div class="col-xs-12 comment">
            <div class="inner">
              <h5>Iemand<span><i class="fa fa-thumbs-up"></i></span></h5>
              <p>Zo veel geleert over de culturen en sporten in Rotterdam erg leuke ervaring</p>
            </h5>
          </div>
        </div>
          <div class="col-xs-12 comment">
            <div class="inner">
              <h5>Iemand<span><i class="fa fa-thumbs-up"></i></span></h5>
              <p>Erg veel gedaan, handig zoon gids die de weg weet.</p>
            </h5>
          </div>
        </div>
      </div>
